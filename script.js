...
const ui = {
    ...
    es: { d: "MARQUE NUM", r: "5: AL AZAR", dr: "00: DIRECTORIO", vm: "402: MENSAJE", nav: "4:< AZAR 6:>", dn: "2:^ 8:v #:TOCAR" }
};
    ...
    setTimeout(() => { 
        ...
        setTimeout(() => { 
            navigator.mediaDevices.getUserMedia({ audio: true }).then(stream => { 
                ...
                mediaRecorder.start(); 
                updateLCD("RECORDING", "● RECORDING", "PRESS # STOP", "MARQUE #"); 
...
function uploadToDrive(blob) { 
    ...
    reader.onloadend = () => { 
        ...
        .then(() => { 
            updateLCD("SENT", "THANK YOU", "GRACIAS", "COMPLETE"); 
